...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/erlik/css/derslikler.css?v=0.162" />
...
if (check_admin_perm()) {
    echo '
    <div class="input-area" id="derslikEklemeSayfasi" style="display:none;">
      <div class="input-area-classroom">
        <div class="title-and-buttons-area">
          <div class="title" id="mainTitle">Derslik Ekleme</div>
          <div class="buttons">
            <a href="#" onclick="derslikEklemeSayfasiAc(\'derslikEklemeSayfasiIptal\')">
        ...
        <div class="inputs">
          <div class="input-iteams-column">
            <div class="input">
              <div class="input-with-label">
                <div class="input-label">Derslik Adı</div>
                <div class="input-layer">
                  <input type="text" class="input-type-text" id="derslikadi"/>
                </div>
              </div>
            </div>
            <div class="input">
              <div class="input-with-label">
                <div class="input-label">Derslik Kapasitesi</div>
                <div class="input-layer">
                  <input type="number" class="input-type-text" id="kapasite" min="0"/> 
                </div>
              </div>
            </div>
          </div>
          <div class="input-iteams-column">
            <div class="input">
              <div class="input-with-label">
                <div class="input-label">Derslik Türü</div>
                <div class="input-layer">
                    <select class="input-type-text" id="tur">
                      <option value="Sınıf">Sınıf</option>
                      <option value="Bilgisayar Laboratuvarı">Bilgisayar Laboratuvarı</option>
                      <option value="Biyomedikal Laboratuvarı">Biyomedikal Laboratuvarı</option>
                      <option value="Elektronik Laboratuvarı">Elektronik Laboratuvarı</option>
                      <option value="Kimya Laboratuvarı">Kimya Laboratuvarı</option>
                      <option value="Makine Atölyesi">Makine Atölyesi</option>
                      <option value="Elektrik ve Elektronik Atölyesi">Elektrik ve Elektronik Atölyesi</option>
                      <option value="Otomotiv Atölyesi">Otomotiv Atölyesi</option>
                    </select>
                </div>
              </div>
            </div>
...
?>
    ...
    <div class="derslikler" id="mainPageAll">
      <?php include "header.php"; ?>
      <div class="main-container">
        <div class="main-title-placement">
          <div class="main-title">Derslikler Tablosu</div>
          <?php
            if (check_admin_perm()) {
              echo '
                <a href="#" onclick="derslikEklemeSayfasiAc(\'ekle\')">
                  <div class="add-btn">
                    <div class="plus">
              ...
              echo '
                <a href="#" onclick="derslikEklemeSayfasiAc(\'ekle\')" style="pointer-events: none;">
        ...
        <div class="table">
          <div class="search-area">
            <div class="search-inputs">
              <input type="text" class="search-text" id="dersliklerAranan" placeholder="Arama"/>
              <a href="#" class="search-btn" id="derslikArama">
            ...
            <div class="search-inputs"> 
              <select class="search-select" id="aramaSutun">
                ...
                <option value="classroom_name">Derslik Adı</option>
                <option value="classroom_capacity">Derslik Kapasitesi</option>
                <option value="classroom_type">Derslik Türü</option>
              </select>
            </div>
          </div>
          <div class="course-table">
            <div class="row">
              ...
              <div class="content-wrapper">
                <div class="content">
                  <div class="title">Derslik Adı</div>
                    <a href="#">
                      <div class="sort-icon">
              ...
              <div class="content-wrapper">
                <div class="content">
                  <div class="title">Derslik Kapasitesi</div>
                    <a href="#">
                      <div class="sort-icon">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M11.3535 2.64645C11.1583 2.45118 10.8417 2.45118 10.6464 2.64645L7.46444 5.82843C7.26918 6.02369 7.26918 6.34027 7.46444 6.53553C7.6597 6.7308 7.97628 6.7308 8.17155 6.53553L10.5 4.20711V13H11.5V4.20711L13.8284 6.53553C14.0237 6.7308 14.3402 6.7308 14.5355 6.53553C14.7308 6.34027 14.7308 6.02369 14.5355 5.82843L11.3535 2.64645Z" fill="#61677A"/>
              ...
              <div class="content-wrapper">
                <div class="content">
                  <div class="title">Derslik Türü</div>
                    <a href="#">
                      <div class="sort-icon">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M11.3535 2.64645C11.1583 2.45118 10.8417 2.45118 10.6464 2.64645L7.46444 5.82843C7.26918 6.02369 7.26918 6.34027 7.46444 6.53553C7.6597 6.7308 7.97628 6.7308 8.17155 6.53553L10.5 4.20711V13H11.5V4.20711L13.8284 6.53553C14.0237 6.7308 14.3402 6.7308 14.5355 6.53553C14.7308 6.34027 14.7308 6.02369 14.5355 5.82843L11.3535 2.64645Z" fill="#61677A"/>
            ...
            <?php include "derslikler_tablo.php"; ?> 
            </div> 
          </div>
        </div>
  ...
  <script src="derslikler.js?v=0.03"></script>
  <script src="filter.js?v=0.01"></script>
  <script src="ekle.js?v=0.09"></script>
</html>
