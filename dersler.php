...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/erlik/css/dersler.css?v=0.196" />
...
if (check_admin_perm()) {
    echo '
    <div class="input-area" id="dersEklemeSayfasi" style="display:none;">
      <div class="input-area-course">
        <div class="title-and-buttons-area">
          <div class="title" id="mainTitle">Ders Ekleme</div>
          <div class="buttons">
            <a href="#" onclick="dersEklemeSayfasiAc(\'dersEklemeSayfasiIptal\')">
        ...
        <form class="inputs"> 
          <div class="input-iteams-column">
            <div class="input">
              <div class="input-with-label">
                <div class="input-label">Ders Adı</div>
                <div class="input-layer">
                  <input type="text" class="input-type-text" id="dersadi"/>
                </div>
              </div>
            </div>
            <div class="input">
              <div class="input-with-label">
                <div class="input-label">Ders Saati</div>
                  <div class="input-layer">
                    <input type="number" step="0.01" min="0" class="input-type-text" id="time"/>
                  </div>
                </div>
            </div>
          </div>
          <div class="input-iteams-column">
            <div class="input">
              <div class="input-label">Ders Türü</div>
              <div class="input-radiobutons-layer">
                <div class="input-type-radiobutton-with-text">
                    <input type="radio" class="input-type-radiobutton" name="dersTuru" id="zorunlu"/>
                    <div class="input-type-radiobutton-text">Zorunlu Ders</div>
                </div>
                <div class="input-type-radiobutton-with-text">
                    <input type="radio" class="input-type-radiobutton" name="dersTuru" id="secmeli"/>
                    <div class="input-type-radiobutton-text">Seçmeli Ders</div>
                </div>
              </div>
            </div>
          </div>
...
?>
    ...
    <div class="dersler" id="mainPageAll">
      <?php include "header.php"; ?>
      <div class="main-container">
        <div class="main-title-placement"> 
          <div class="main-title">Dersler Tablosu</div>
          <?php
            if (check_admin_perm()) {
              echo '
              ...
              echo '
                <div class="add-btn" style="opacity: 0.5; cursor: not-allowed; pointer-events: none; transition: none;">
                  <div class="plus">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M4 12H20M12 4V20" stroke="#FCFAFA" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
        ...
        <div class="table">
          <div class="search-area">
            <div class="search-inputs">
              <input type="text" class="search-text" id="derslerAranan" placeholder="Arama"/>
              <a href="#" class="search-btn" id="derslerArama">
            ...
            <div class="search-inputs"> 
              <select class="search-select" id="aramaSutun">
                ...
                <option value="course_name">Ders Adı</option>
                <option value="course_length">Ders Saati</option>
                <option value="course_mandatory">Seçmeli/Zorunlu</option>
              </select>
            </div>
          </div>
          <div class="course-table">
            <div class="header-row">
              ...
              <div class="content-wrapper">
                <div class="content">
                  <div class="title">Ders Saati</div>
                  <a href="#">
                    <div class="sort-icon">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.3535 2.64645C11.1583 2.45118 10.8417 2.45118 10.6464 2.64645L7.46444 5.82843C7.26918 6.02369 7.26918 6.34027 7.46444 6.53553C7.6597 6.7308 7.97628 6.7308 8.17155 6.53553L10.5 4.20711V13H11.5V4.20711L13.8284 6.53553C14.0237 6.7308 14.3402 6.7308 14.5355 6.53553C14.7308 6.34027 14.7308 6.02369 14.5355 5.82843L11.3535 2.64645Z" fill="#61677A"/>
              ...
              <div class="div-wrapper">
                <div class="content-2">
                  <div class="title">Seçmeli / Zorunlu</div>
                  <a href="#">
                    <div class="sort-icon">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.3535 2.64645C11.1583 2.45118 10.8417 2.45118 10.6464 2.64645L7.46444 5.82843C7.26918 6.02369 7.26918 6.34027 7.46444 6.53553C7.6597 6.7308 7.97628 6.7308 8.17155 6.53553L10.5 4.20711V13H11.5V4.20711L13.8284 6.53553C14.0237 6.7308 14.3402 6.7308 14.5355 6.53553C14.7308 6.34027 14.7308 6.02369 14.5355 5.82843L11.3535 2.64645Z" fill="#61677A"/>
  ...
  <script src="dersler.js?v=0.12"></script>
  <script src="ekle.js?v=0.06"></script>
  <script src="filter.js?v=0.05"></script>
</html>
