...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/erlik/css/programlar.css?v=0.162" />
    <link rel="stylesheet" href="/erlik/css/sidebar.css?v=v0.141" />
    <link rel="stylesheet" href="/erlik/css/header.css?v=0.121" />
    <title>Programlar</title> 
  </head>
  <body> 
    <div class="input-area" id="programEklemeSayfasi" style="display:none;">
      <div class="input-area-program">
        <div class="title-and-buttons-area">
          <div class="title" id="mainTitle">Program/Sınıf Ekleme</div>
          <div class="buttons">
            <a href="#" onclick="programEklemeSayfasiAc('programlarSayfasiIptalEt')">
        ...
        <div class="inputs">
          <div class="input-iteams-column">
            <div class="input">
              <div class="input-with-label">
                <div class="input-label">Program Adı</div>
                <div class="input-layer">
                  <input type="text" class="input-type-text" id="programAdi"/>
                </div>
              </div>
            </div>
            <div class="input">
              <div class="input-with-label">
                <div class="input-label">Sınıf Senesi</div>
                <div class="input-layer">
                  <input type="number" class="input-type-text" id="sinifSenesi" min="0"/>
                </div>
              </div>
            </div>
          </div>
          <div class="input-iteams-column">
            <div class="input">
              <div class="input-with-label">
                <div class="input-label">Öğrenci Sayısı</div>
                <div class="input-layer">
                  <input type="number" class="input-type-text" id="ogrenciSayisi" min="0">
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="programlar" id="mainPageAll">
      <?php include "header.php"; ?>
      <div class="main-container">
        <div class="main-title-placement">
          <div class="main-title">Programlar Tablosu</div>
          <?php
if (check_admin_perm()) {
  echo '
    <a href="#" onclick="programEklemeSayfasiAc(\'ekle\')">
      <div class="add-btn">
        <div class="plus">
  ...
  echo '
    <a href="#" onclick="programEklemeSayfasiAc(\'ekle\')" style="pointer-events: none;">
...
?>
        ...
        <div class="search-area">
            <div class="search-inputs">
              <input type="text" class="search-text" placeholder="Arama" id="programlarAranan">
              <a href="#" class="search-btn" id="programlarArama">
            ...
            <div class="search-inputs">
              <select class="search-select" id="aramaSutun">
                ...
                <option value="program_name">Program Adı</option>
                <option value="program_class">Sınıf</option>
                <option value="program_headcount">Öğrenci Sayısı</option>
              </select>
            </div>
          </div>
          <div class="program-table">
            <div class="header-row">
              ...
              <div class="content-wrapper">
                <div class="content">
                  <div class="title">Öğrenci Sayısı</div>
                    <a href="#">
                      <div class="sort-icon">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M11.3535 2.64645C11.1583 2.45118 10.8417 2.45118 10.6464 2.64645L7.46444 5.82843C7.26918 6.02369 7.26918 6.34027 7.46444 6.53553C7.6597 6.7308 7.97628 6.7308 8.17155 6.53553L10.5 4.20711V13H11.5V4.20711L13.8284 6.53553C14.0237 6.7308 14.3402 6.7308 14.5355 6.53553C14.7308 6.34027 14.7308 6.02369 14.5355 5.82843L11.3535 2.64645Z" fill="#61677A"/>
            ...
            <?php include "programlar_tablo.php"; ?>
            </div>
          </div>
        </div>
  ...
  <script src="programlar.js?v=0.0"></script>
